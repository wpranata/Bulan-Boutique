$(document).ready(function() {
    ...
    for (let i = 1; i <= imageLength; i++) {
        $("#men_dot_" + i).bind('click', function() {
            stopInterval();
            currentImageIndex = i - 1;
            move_slider_images(currentImageIndex, 0.2);
            set_dots_background("men_dot_" + i);
            startInterval();
        });
    }

    $("#men_arrow_left").bind('click', function() {
        stopInterval();
        move_slider_images(--currentImageIndex, 0.2);
    ...
    $("#men_arrow_right").bind('click', function() {
        stopInterval();
        move_slider_images(++currentImageIndex, 0.2);
        setTimeout(validate_image_index, 150);
        startInterval();
    ...
    function validate_image_index() {
        ...
        set_dots_background("men_dot_" + (currentImageIndex + 1));
    }
